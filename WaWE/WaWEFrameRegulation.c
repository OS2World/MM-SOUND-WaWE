...
#ifdef DEBUG_BUILD
  printf("Starting FrameRegulator thread\n");
  fflush(stdout);
#endif
...
#ifdef DEBUG_BUILD
  printf("Halting FrameRegulator thread\n");
  fflush(stdout);
#endif
...
{
#ifdef DEBUG_BUILD
//  printf("Initialize_FrameRegulation()\n");
//  fflush(stdout);
#endif
  FrameRegulatorThread = 0;
  return 1;
...
{
#ifdef DEBUG_BUILD
//  printf("Uninitialize_FrameRegulation()\n");
//  fflush(stdout);
#endif
  StopFrameRegulation();
}
